...
// Source: github.com/specterops/apihound/cmd/api/src/services/fs (interfaces: Service)
//
// Generated by this command:
//
//	mockgen -copyright_file=../../../../../LICENSE.header -destination=./mocks/fs.go -package=mocks . Service
//
