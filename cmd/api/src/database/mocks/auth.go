...
// Source: github.com/specterops/apihound/cmd/api/src/database (interfaces: AuthContextInitializer)
//
// Generated by this command:
//
//	mockgen -copyright_file=../../../../LICENSE.header -destination=./mocks/auth.go -package=mocks . AuthContextInitializer
//
...
import (
	...
	auth "github.com/specterops/apihound/cmd/api/src/auth"
...
func (mr *MockAuthContextInitializerMockRecorder) InitContextFromToken(ctx, authToken any) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InitContextFromToken", reflect.TypeOf((*MockAuthContextInitializer)(nil).InitContextFromToken), ctx, authToken)
}
