...
import (
	...
	mocks_db "github.com/specterops/apihound/cmd/api/src/database/mocks"
	...
	graphmocks "github.com/specterops/apihound/cmd/api/src/vendormocks/dawgs/graph"
...
func TestResources_GetAssetGroupTagMemberInfo(t *testing.T) {
	...
	apitest.
		...
		Run([]apitest.Case{
			...
			{
				Name: "DB error - GetDisplayNodeGraphKindsError",
				Input: func(input *apitest.Input) {
...
func Test_GetAssetGroupMembersByTag(t *testing.T) {
	...
	apitest.NewHarness(t, resources.GetAssetGroupMembersByTag).
		Run([]apitest.Case{
			...
			{
				Name: "Fail with GetDisplayNodeGraphKindsError",
				Input: func(input *apitest.Input) {
					apitest.SetURLVar(input, api.URIPathVariableAssetGroupTagID, "1")
				},
				Setup: func() {
...
func TestResources_PreviewSelectors(t *testing.T) {
	...
	apitest.
		...
		Run([]apitest.Case{
			...
			{
				Name: "Internal Server Error - GetDisplayNodeGraphKindsError",
				Input: func(input *apitest.Input) {
					apitest.SetContext(input, userCtx)
					apitest.BodyStruct(input, v2.PreviewSelectorBody{
...
func TestResources_SearchAssetGroupTags(t *testing.T) {
	...
	t.Run("GetDisplayNodeGraphKindsError", func(t *testing.T) {
		mockDB.EXPECT().GetDisplayNodeGraphKinds(gomock.Any()).Return(nil, errors.New("database error"))
