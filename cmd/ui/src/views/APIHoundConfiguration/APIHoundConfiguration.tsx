...
const APIHoundConfiguration = () => {
    return (
        <PageWithTitle
            title='APIHound Configuration'
            pageDescription={
                <p className='text-sm'>
                    Modify the configuration of your APIHound tenant. See our{' '}
                    <a
                        className='text-link underline'
                        href='https://apihound.specterops.io/analyze-data/apihound-gui/configuration'>
                        documentation
                    </a>{' '}
...
export default APIHoundConfiguration;
