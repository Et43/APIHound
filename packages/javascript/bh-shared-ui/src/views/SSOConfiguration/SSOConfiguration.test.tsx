...
const initialSAMLProvider: SSOProvider = {
    ...
    details: {
        ...
        sp_issuer_uri: 'http://apihound.localhost/api/v2/login/saml/test-idp-1',
        sp_sso_uri: 'http://apihound.localhost/api/v2/login/saml/test-idp-1/sso',
        sp_metadata_uri: 'http://apihound.localhost/api/v2/login/saml/test-idp-1/metadata',
        sp_acs_uri: 'http://apihound.localhost/api/v2/login/saml/test-idp-1/acs',
    } as SAMLProviderInfo,
    login_uri: '',
    callback_uri: '',
...
const newSAMLProvider: SSOProvider = {
    ...
    details: {
        ...
        principal_attribute_mappings: null,
        sp_issuer_uri: 'http://apihound.localhost/api/v2/login/saml/test-idp-2',
        sp_sso_uri: 'http://apihound.localhost/api/v2/login/saml/test-idp-2/sso',
        sp_metadata_uri: 'http://apihound.localhost/api/v2/login/saml/test-idp-2/metadata',
        sp_acs_uri: 'http://apihound.localhost/api/v2/login/saml/test-idp-2/acs',
    } as SAMLProviderInfo,
    login_uri: '',
    callback_uri: '',
